...
(function() {
  var Character, Direction, GameObject, Jukebox, LogoScene, MaWorld, MainScene, Map, MapObject, Player, RotateDirection, Tile, TileSet, TileType, Timer, Vector,
  ...
  MainScene = (function(_super) {
    ...
    MainScene.prototype.onMousePressed = function(e) {
      ...
      set = this.map.rotate(v.x, v.y, RotateDirection.Left);
      if (set !== null) {
