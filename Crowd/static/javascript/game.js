...
(function() {
  var GameObject, Jukebox, LogoScene, MaWorld, MainScene, Map, Tile, TileType, Timer, Vector,
  ...
  MaWorld = (function(_super) {
    ...
    MaWorld.prototype.config = {
      ...
      FONT: 'Helvetica',
      IMAGE_PATH: '/image/',
      IMAGES: ['kawaz.png', 'chips/grass.png'],
      SOUND_PATH: '/sound/',
      SOUNDS: [],
      INITIAL_LEVEL: 1,
      LAST_LEVEL: 7,
  ...
  Tile = (function(_super) {
    ...
    function Tile() {
      Tile.__super__.constructor.call(this, 48, 48);
